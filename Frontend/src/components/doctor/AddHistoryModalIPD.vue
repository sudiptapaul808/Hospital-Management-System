...
const addHistory = async() => {
    ...
    try {
        await api.post(`/api/doctor/ipd/${props.patientId}/history/new`, {
...
//Fetch the list of departments the doctor belongs to for the dropdown========================================================
...
//Fetch the list of departments when the modal mounts=========================================================================
onMounted(() => {
    fetchDepartments()
})
</script>
